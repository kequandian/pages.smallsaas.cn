export default {
   'GET /api/vip/account/grade/rules': (req, res) => {
      res.send({
        code: 200,
        data: {
          current:1,
    ...
    'POST /api/vip/account/grade/rules/*': (req, res) => {
      res.send({
        code: 200,
      });
    },
    'PUT /api/vip/account/grade/rules/*': (req, res) => {
      res.send({
        code: 200,
      });
    },
    'DELETE /api/vip/account/grade/rules/*': (req, res) => {
      res.send({
        code: 200,
      });
    },
