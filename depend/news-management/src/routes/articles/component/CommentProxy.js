...
export default class CommentProxy extends Component{
  ...
  render(){
    return <EventProxy { ...this.props }
      // tableAPI="/api/cms/evaluations?stockType=Article&stockId=[id]"
      // tableAPI="/api/gw/expore/info/evaluations?stockType=Article&stockId=[id]"
      tableAPI="/api/gw/expore/info/evaluations?stockType=Article&stockId=[id]&isLayered=true"
    >
