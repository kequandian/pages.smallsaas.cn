  ...
  render() {
    ...
    return (
      <SelectTrigger
        ...
        dropdownMenuExtra={props.dropdownMenuExtra}
      ...
      >
        ...
        >
          <div
            ...
            key="selection"
            className={`${prefixCls}-selection ${prefixCls}-selection-kqd
            ...
            {...extraSelectionProps}
          >
            { props.addonBefore ? <div className={ `${prefixCls}-selection-addonBefore` } >{ props.addonBefore }</div> : undefined }
            {ctrlNode}
            {this.renderClear()}
